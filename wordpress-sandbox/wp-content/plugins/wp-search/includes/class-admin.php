...
class Admin {
	 ...
	 *
	 * Default is 'j' (Isaac's accepted IA-195 resolution, verified live
	 * 2026-08-18). Users can override to any a–z key.
	 *
	 * @since 1.0.0
	 * @var string
	 */
	const DEFAULT_SHORTCUT_KEY = 'j';
	...
	public function render_shortcut_key_field(): void {
		...
		<label>
			...
			<span class="description">
				<?php
				esc_html_e( 'Keyboard shortcut key (a–z). Default: j. Example: press Ctrl+', 'wp-search' );
